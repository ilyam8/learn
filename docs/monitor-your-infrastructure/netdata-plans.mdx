---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/manage/plans.md"
sidebar_label: "Netdata plans"
learn_status: "Published"
learn_rel_path: "Monitor your Infrastructure"
sidebar_position: "918000"
---
# Netdata Plans
...
> you to invite or change users using the Member role. See more details on our [roles and plans](/docs/configuring/securing-netdata-agents/role-based-access-model#what-roles-are-available) documentation.
...
To achieve this you can check the [Update plan](/docs/monitor-your-infrastructure/view-plan-&-billing#update-plan) section.
...
> ⚠️ Downgrade or cancellation may affect users in your Space. Please check what roles are available on the [each plans](/docs/monitor-your-infrastructure/netdata-plans#areas-impacted-by-plans). Users with unavailable roles on the new plan will immediately have restricted access to the Space.
...
For more details check the documentation under [Role-Based Access model](/docs/configuring/securing-netdata-agents/role-based-access-model).
...
For more details check the documentation under [Events feed](/docs/visualizations/events-feed).
...
For more details check the documentation under [Alert Notifications](/docs/alerting/notifications/netdata-cloud-notifications#alert-notifications).
...
For more details check the documentation under [Alert Notifications](/docs/alerting/notifications/netdata-cloud-notifications#silencing-alert-notifications).
...
* [Role-Based Access model](/docs/configuring/securing-netdata-agents/role-based-access-model)

#### Related Tasks

* [View Plan & Billing](/docs/monitor-your-infrastructure/view-plan-&-billing)
