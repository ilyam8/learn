...
learn_link: "https://learn.netdata.cloud/docs/architecture/the-role-of-netdata-cloud"
---
...
<Grid columns="2">
  ...
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/alerting/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference)" title="Alert notifications" />
    </BoxList>
  </Box>
  <Box
...
- Alerts and notifications
  ...
  - [Alert notifications](/docs/alerting/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference)
