...
- The [Nodes tab](/docs/visualizations/nodes-view) gives you the ability to see the status (offline or online), host details, alert status and also a short overview of some key metrics from all your nodes at a glance.
...
<Grid columns="2">
  ...
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/visualizations/nodes-view)" title="Nodes tab" />
...
- Dashboards
  ...
  - [Nodes tab](/docs/visualizations/nodes-view)
