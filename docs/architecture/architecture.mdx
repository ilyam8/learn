...
sidebar_position: "0"
learn_link: "https://learn.netdata.cloud/docs/architecture"
---
...
- **30+ external time-series databases**: Export resampled metrics as they're collected to other [local- and
    Cloud-based databases](/docs/exporting/exporting-quickstart) for best-in-class
    interoperability.
...
Prometheus collector](/docs/data-collection/generic-data-collection/prometheus-endpoint). This even
