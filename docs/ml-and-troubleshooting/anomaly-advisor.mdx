---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/insights/anomaly-advisor.md"
...
learn_link: "https://learn.netdata.cloud/docs/ml-and-troubleshooting/anomaly-advisor"
---
...
When you have finished your configuration, restart Netdata with a command like `sudo systemctl restart netdata` for the config changes to take effect. You can find more info on restarting Netdata [here](/docs/maintaining/starting-and-stopping-netdata-agents).
