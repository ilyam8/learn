...
sidebar_position: "1410000"
learn_link: "https://learn.netdata.cloud/docs/ml-and-troubleshooting/run-time-troubleshooting-with-functions"
---
...
* Ensure that the node has the collector that exposes the function you want enabled ([see current available functions](/docs/visualizations/functions#what-functions-are-currently-available))
...
### **Related Concepts**
- [Netdata Functions](/docs/visualizations/functions)
