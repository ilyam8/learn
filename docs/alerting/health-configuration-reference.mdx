...
[simple pattern](/docs/contributing/libnetdata/simple-patterns) that
...
- A few lines use space-separated lists to define how the entity behaves. You can use `*` as a wildcard or prefix with
    `!` for a negative match. Order is important, too! See our [simple patterns docs](/docs/contributing/libnetdata/simple-patterns) for
    more examples.
...
list of [simple patterns](/docs/contributing/libnetdata/simple-patterns). For example,
...
list of [simple patterns](/docs/contributing/libnetdata/simple-patterns). For
...
The value is a space-separated list of [simple patterns](/docs/contributing/libnetdata/simple-patterns). For
...
The value is a space-separate list of simple patterns. See our [simple patterns docs](/docs/contributing/libnetdata/simple-patterns) for
some examples.
...
See our [simple patterns docs](/docs/contributing/libnetdata/simple-patterns) for more examples.
...
> If you don't know how to find the CHART_NAME, you can read about it [here](/docs/contributing/web#charts).
...
templates for charts belonging to a given [context](/docs/contributing/web#contexts). The reason is that all charts of a given
context are essentially identical, with the only difference being the [family](/docs/contributing/web#families) that
...
a [Netdata simple pattern](/docs/contributing/libnetdata/simple-patterns) to create
...
Use a [simple pattern](/docs/contributing/libnetdata/simple-patterns)! One example of a simple pattern is a single wildcard
(`*`).
...
our [simple patterns documentation](/docs/contributing/libnetdata/simple-patterns).
