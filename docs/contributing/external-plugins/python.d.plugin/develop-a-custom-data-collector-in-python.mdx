...
learn_rel_path: "Contributing/External plugins/python.d.plugin"
...
sidebar_position: "1308081"
---
# Develop a custom data collector in Python

The Netdata Agent uses [data collectors](/docs/data-collection) to 
fetch metrics from hundreds of system, container, and service endpoints. While the Netdata team and community has built 
[powerful collectors](/docs/data-collection/monitor-anything) for most system, container, 
...
## What you need to get started
  ...
  - A working [installation of Netdata](/docs/installing) monitoring agent.
...
[installed Netdata from a GitHub fork](/docs/installing/from-a-git-checkout) you
...
[External Plugins Documentation](/docs/contributing/external-plugins).
...
You can read more about `family` and `context` in the [web dashboard](/docs/contributing/web#families) doc.
...
[Restart Netdata](/docs/maintaining/starting-and-stopping-netdata-agents) with `sudo systemctl restart netdata` to see the new humidity
chart:
...
[Restart Netdata](/docs/maintaining/starting-and-stopping-netdata-agents) with `sudo systemctl restart netdata` to see the new
...
documentation](/docs/contributing/external-plugins/python.d.plugin). 
