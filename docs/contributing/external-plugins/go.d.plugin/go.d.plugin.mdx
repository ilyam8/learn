...
learn_rel_path: "Contributing/External plugins/go.d.plugin"
...
the [official installation method](/docs/installing#install-on-linux-with-one-line-installer).
...
|:--------------|:--------------------------------------------------------------------------------------------------------:|
| CAP_NET_RAW   |      [Ping](/docs/data-collection/synthetic-checks/network-latency-check#requirements)      |
| CAP_NET_ADMIN | [Wireguard](/docs/data-collection/vpns/wireguard#requirements) |
...
Netdata [config directory](/docs/configuring/configuration), which is typically
at `/etc/netdata`.
...
Then [restart netdata](/docs/maintaining/starting-and-stopping-netdata-agents) for the
change to take effect.

## Contributing

If you want to contribute to this project, we are humbled. Please take a look at
our [contributing guidelines](/docs/contributing) and don't hesitate to
contact us in our forums.

### How to develop a collector

Read [how to write a Netdata collector in Go](/docs/contributing/external-plugins/go.d.plugin/how-to-write-a-netdata-collector-in-go).
...
- [Netdata Code of Conduct](/docs/contributing/community-code-of-conduct)
