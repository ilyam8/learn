...
sidebar_position: "1606041"
learn_link: "https://learn.netdata.cloud/docs/contributing/external-plugins/go.d.plugin/how-to-write-a-netdata-collector-in-go"
---
...
- If you want to test the collector with the actual Netdata Agent, you need to replace the `go.d.plugin` binary that
  ...
  you [restart](/docs/maintaining/starting-and-stopping-netdata-agents) the Netdata Agent, it will detect and run
