...
learn_rel_path: "Contributing/External plugins"
sidebar_position: "1308000"
---
...
|:------------------------------------------------------------------------------------------------------:|:--------:|:--------------:|:----------------------------------------------------------------------------------------------------------------------------------------|
|     [apps.plugin](/docs/data-collection/apm/application-monitoring)     |   `C`    | linux, freebsd | monitors the whole process tree on Linux and FreeBSD and breaks down system resource usage by **process**, **user** and **user group**. |
| [charts.d.plugin](/docs/contributing/external-plugins/charts.d.plugin) |  `BASH`  |      all       | a **plugin orchestrator** for data collection modules written in `BASH` v4+.                                                            |
|     [cups.plugin](/docs/data-collection/hardware-devices-and-sensors/cups.plugin)     |   `C`    |      all       | monitors **CUPS**                                                                                                                       |
|     [ebpf.plugin](/docs/data-collection/linux-systems/ebpf-for-systems-monitoring)     |   `C`    |     linux      | monitors different metrics on environments using kernel internal functions.                                                             |
|              [go.d.plugin](/docs/contributing/external-plugins/go.d.plugin)               |   `GO`   |      all       | collects metrics from the system, applications, or third-party APIs.                                                                    |
|   [ioping.plugin](/docs/data-collection/synthetic-checks/disk-latency-with-check)   |   `C`    |      all       | measures disk latency.                                                                                                                  |
| [freeipmi.plugin](/docs/data-collection/hardware-devices-and-sensors/server-hardware) |   `C`    |     linux      | collects metrics from enterprise hardware sensors, on Linux servers.                                                                    |
|   [nfacct.plugin](/docs/data-collection/networking-stack-and-network-interfaces/netfilter-accounting)   |   `C`    |     linux      | collects netfilter firewall, connection tracker and accounting metrics using `libmnl` and `libnetfilter_acct`.                          |
|  [xenstat.plugin](/docs/data-collection/containers-and-vms/xen)  |   `C`    |     linux      | collects XenServer and XCP-ng metrics using `lxenstat`.                                                                                 |
|     [perf.plugin](/docs/data-collection/linux-systems/other/perf)     |   `C`    |     linux      | collects CPU performance metrics using performance monitoring units (PMU).                                                              |
| [python.d.plugin](/docs/contributing/external-plugins/python.d.plugin) | `python` |      all       | a **plugin orchestrator** for data collection modules written in `python` v2 or v3 (both are supported).                                |
| [slabinfo.plugin](/docs/data-collection/linux-systems/other/slabinfo) |   `C`    |     linux      | collects kernel internal cache objects (SLAB) metrics.                                                                                  |
...
1.  **python**, use `python.d.plugin`, there are many examples in the [python.d
    directory](/docs/contributing/external-plugins/python.d.plugin)
...
2.  **BASH**, use `charts.d.plugin`, there are many examples in the [charts.d
    directory](/docs/contributing/external-plugins/charts.d.plugin)
