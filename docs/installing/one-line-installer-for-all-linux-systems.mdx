...
learn_link: "https://learn.netdata.cloud/docs/installing/one-line-installer-for-all-linux-systems"
---
...
```bash
[ "76cad9f1c374345f2b3e93d0f316dce2" = "$(curl -Ss https://get.netdata.cloud/kickstart.sh | md5sum | cut -d ' ' -f 1)" ] && echo "OK, VALID" || echo "FAILED, INVALID"
```
