...
sidebar_position: "230000"
learn_link: "https://learn.netdata.cloud/docs/installing/azure"
---
...
we recommend the [`kickstart.sh` automatic installation script](/docs/installing/one-line-installer-for-all-linux-systems).
