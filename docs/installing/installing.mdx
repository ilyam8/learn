...
learn_link: "https://learn.netdata.cloud/docs/installing"
---
...
Netdata is very flexible and can be used to monitor all kinds of infrastructure. Read more about possible [Deployment strategies](/docs/architecture/deployment-strategies) to understand what better suites your needs.
...
Together with [Netdata Cloud](/docs/architecture/the-role-of-netdata-cloud), you can monitor your entire infrastructure in
...
in the Overview tab. [Read more about the cloud features](/docs/architecture/the-role-of-netdata-cloud).
...
Discover the recommended way to [configure Netdata's settings or behavior](/docs/configuring/configuration) using our built-in
`edit-config` script, then apply that knowledge to mission-critical tweaks, such as [changing how long Netdata stores
metrics](/docs/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics).
...
[enable notifications](/docs/alerting/notifications) to customize your Netdata experience.

#### Make your deployment production ready

Go through our [deployment strategies](/docs/architecture/deployment-strategies),
...
[kickstart script](/docs/installing/one-line-installer-for-all-linux-systems).
...
<InstallRegexLink>
  <InstallBoxRegexLink
    to="[](/docs/installing/docker)"
    os="Run with Docker"
    svg="docker" />
  <InstallBoxRegexLink
    to="[](/docs/installing/kubernetes)"
    os="Deploy on Kubernetes"
    svg="kubernetes" />
   <InstallBoxRegexLink
    to="[](/docs/installing/macos)"
    os="Install on macOS"
    svg="macos" />
  <InstallBoxRegexLink
    to="[](/docs/installing/native-linux-distribution-packages)"
    os="Native DEB/RPM packages"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/installing/from-a-git-checkout)"
    os="Linux from Git"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/installing/build-the-netdata-agent-yourself/compile-from-source-code)"
    os="Linux from source"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/installing/offline-systems)"
    os="Linux for offline nodes"
    svg="linux" />
</InstallRegexLink>

- [Native DEB/RPM packages](/docs/installing/native-linux-distribution-packages)
- [Run with Docker](/docs/installing/docker)
- [Deploy on Kubernetes](/docs/installing/kubernetes)
- [Install on macOS](/docs/installing/macos)
- [Linux from Git](/docs/installing/from-a-git-checkout)
- [Linux from source](/docs/installing/build-the-netdata-agent-yourself/compile-from-source-code)
- [Linux for offline nodes](/docs/installing/offline-systems)
...
Netdata](/docs/maintaining/update-netdata-agents).
...
2. If you are using a system that we publish native packages for (see our [platform support
   policy](/docs/installing/platform-support-policy) for more details),
   you can manually set up our native package repositories as outlined in our [native package install
   documentation](/docs/installing/native-linux-distribution-packages). Our official
...
3. If neither of the above options work for you, you can still install using our [offline installation
   instructions](/docs/installing/offline-systems), though
...
PowerTools, to gather hard dependencies. See the [CentOS 6](/docs/installing/from-a-git-checkout#centos--rhel-6x) and
[CentOS 8](/docs/installing/from-a-git-checkout#centos--rhel-8x) sections for more information.
...
errors](/docs/installing/from-a-git-checkout#nonrepresentable-section-on-output-errors) for a workaround.
