...
Netdata supports exporting metrics to Prometheus in two ways:
 ...
 - You can [configure Netdata to push metrics to Prometheus](/docs/exporting/prometheus/remote-write)
...
of [simple patterns](/docs/contributing/libnetdata/simple-patterns) to match the
