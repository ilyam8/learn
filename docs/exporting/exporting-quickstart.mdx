...
learn_link: "https://learn.netdata.cloud/docs/exporting/exporting-quickstart"
---
...
-   **AWS Kinesis**: [AWS Kinesis Data Streams](/docs/exporting/aws-kinesis)
...
-   **Google Cloud Pub/Sub**: [Google Cloud Pub/Sub Service](/docs/exporting/google-cloud-pub-sub)
...
-   **JSON**: [JSON document databases](/docs/exporting/json)
