...
sidebar_position: "1738000"
learn_link: "https://learn.netdata.cloud/docs/miscellaneous/monitor-any-process-in-real-time-with-netdata"
---
...
- One or more Linux nodes running [Netdata](/docs/installing)
- A general understanding of how
  to [configure the Netdata Agent](/docs/configuring/configuration)
  using `edit-config`.
...
the [appropriate method](/docs/maintaining/starting-and-stopping-netdata-agents) for your system, to start collecting utilization metrics
