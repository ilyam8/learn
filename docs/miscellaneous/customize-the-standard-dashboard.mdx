---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/dashboard/customize.md"
...
> ### Disclaimer
>
> This document is only applicable to the v1 version of the dashboard and doesn't affect the [Netdata Dashboard](/docs/visualizations/accessing-netdata-dashboards).

While the [Netdata dashboard](/docs/visualizations/accessing-netdata-dashboards/netdata-agent-dashboards) comes preconfigured with hundreds of charts and
...
Save the file, then navigate to your [Netdata config directory](/docs/configuring/configuration) to edit `netdata.conf`. Add
