...
a [new CockroachDB collector](/docs/data-collection/database-servers/cockroachdb)
released in
...
method](/docs/maintaining/starting-and-stopping-netdata-agents) for your system, and refresh your browser. You should see CockroachDB
...
For more information about editing the defaults or writing new alert entities, see our documentation on [configuring health alerts](/docs/alerting/health-configuration-reference).
