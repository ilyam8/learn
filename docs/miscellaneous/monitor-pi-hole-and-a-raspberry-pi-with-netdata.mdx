...
sidebar_position: "1732000"
learn_link: "https://learn.netdata.cloud/docs/miscellaneous/monitor-pi-hole-(and-a-raspberry-pi)-with-netdata"
---
...
collector](/docs/data-collection/dns-and-dhcp-servers/pi-hole) will autodetect the new service
...
If you're completely new to Netdata, look at the [Introduction](/docs/architecture) section for a walkthrough of all its features. For a more expedited tour, see the [get started documentation](/docs/installing).

### Enable temperature sensor monitoring

You need to manually enable Netdata's built-in [temperature sensor
collector](/docs/data-collection/hardware-devices-and-sensors/linux-sensors-sysfs) to start collecting metrics.
