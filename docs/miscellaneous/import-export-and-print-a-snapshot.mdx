---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/dashboard/import-export-print-snapshot.md"
...
timeframe](/docs/monitor-your-infrastructure/visualization-date-and-time-controls) when the alert triggered, export a snapshot, and send it to a
