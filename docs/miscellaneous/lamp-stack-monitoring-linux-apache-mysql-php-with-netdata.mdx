...
sidebar_position: "1730000"
learn_link: "https://learn.netdata.cloud/docs/miscellaneous/lamp-stack-monitoring-(linux-apache-mysql-php)-with-netdata"
---
...
collector](/docs/data-collection/web-servers-and-web-proxies/web-server-log-files), which reads Apache's access
...
collector](/docs/data-collection/databases/mysql) collects metrics in _read-only_
...
Click the 🔔 icon in the top navigation to [see active alerts](/docs/monitor-your-infrastructure/view-active-alerts). The **Active** tabs
...
collector](/docs/data-collection/synthetic-checks/http-endpoints), which pings a web server at
...
- [Netdata Agent · Web log collector](/docs/data-collection/web-servers-and-web-proxies/web-server-log-files)
- [Netdata Agent · MySQL data collector](/docs/data-collection/databases/mysql)
