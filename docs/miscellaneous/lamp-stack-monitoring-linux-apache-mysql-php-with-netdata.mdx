...
kickstart command](/docs/installing):
...
There's nothing you need to do to enable [system monitoring](/docs/data-collection/system-metrics) and Linux monitoring with
...
metrics from each using the [cgroups data collector](/docs/data-collection/containers-and-vms/cgroups).

## Enable Apache monitoring

Let's begin by configuring Apache to work with Netdata's [Apache data
collector](/docs/data-collection/web-servers-and-web-proxies/apache).
...
collector](/docs/data-collection/web-servers-and-web-proxies/web-logs/apache-nginx-microsoft-iis), which reads Apache's access
...
collector](/docs/data-collection/database-servers/mysql-and-mariadb) collects metrics in _read-only_
...
system](/docs/maintaining/starting-and-stopping-netdata-agents), to collect dozens of metrics every second for robust MySQL monitoring.
...
with [StatsD](/docs/data-collection/apm/statsd).

However, if you use [PHP-FPM](https://php-fpm.org/) in your LAMP stack, you can monitor that process with our [PHP-FPM
data collector](/docs/data-collection/web-servers-and-web-proxies/php-fpm).
...
> [connecting your node](/docs/configuring/connect-agent-to-cloud) to start streaming metrics to your browser through Netdata Cloud.
...
out. Check out our doc on [interacting with charts](/docs/visualizations/netdata-charts) for all the details.
...
[Tweak alerts](/docs/alerting/health-configuration-reference) based on your infrastructure monitoring needs, and to see these alerts
in other places, like your inbox or a Slack channel, [enable a notification
method](/docs/alerting/notifications).
...
collector](/docs/data-collection/synthetic-checks/http-endpoints-check), which pings a web server at
...
source of issues faster with [Metric Correlations](/docs/ml-and-troubleshooting/metric-correlations),
[sign up](https://app.netdata.cloud/sign-up?cloudRoute=/spaces) for a free Netdata Cloud account.

### Related reference documentation

- [Netdata Agent · Get started](/docs/installing)
- [Netdata Agent · Apache data collector](/docs/data-collection/web-servers-and-web-proxies/apache)
- [Netdata Agent · Web log collector](/docs/data-collection/web-servers-and-web-proxies/web-logs/apache-nginx-microsoft-iis)
- [Netdata Agent · MySQL data collector](/docs/data-collection/database-servers/mysql-and-mariadb)
- [Netdata Agent · PHP-FPM data collector](/docs/data-collection/web-servers-and-web-proxies/php-fpm)
