---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/metrics-storage-management/enable-streaming.md"
sidebar_label: "Understanding How Streaming Works"
...
sidebar_position: "502000"
learn_link: "https://learn.netdata.cloud/docs/streaming/understanding-how-streaming-works"
---
...
[trigger alerts](/docs/monitor-your-infrastructure/view-active-alerts) and 
[send notifications](/docs/alerting/notifications), and
[export](/docs/exporting/exporting-quickstart) all metrics to an external TSDB. When Netdata streams metrics to another
...
[distributed architecture](/docs/architecture/distributed-data-architecture) is 
...
- When your nodes have severe RAM and disk IO limitations (e.g. Raspberry Pis), you should
  [optimize the Netdata agent's performance](/docs/configuring/how-to-optimize-the-netdata-agent-s-performance).

[Secure your nodes](/docs/configuring/securing-netdata-agents) to 
...
[without transferring the collected data](/docs/architecture/security-and-privacy-design). 
...
[alert notifications](/docs/alerting/notifications) from either or both nodes.
...
Next, open `stream.conf` using [`edit-config`](/docs/configuring/configuration#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/configuring/configuration#the-netdata-config-directory).
...
method](/docs/maintaining/starting-and-stopping-netdata-agents) for your system.
...
method](/docs/maintaining/starting-and-stopping-netdata-agents) for your system, to stream encrypted metrics using TLS/SSL.
