...
learn_link: "https://learn.netdata.cloud/docs/configuring/how-to-optimize-the-netdata-agent's-performance"
---
...
| [Change how long Netdata stores metrics](/docs/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics) |                    | :heavy_check_mark: | :heavy_check_mark: |
...
1. [Change how long Netdata stores metrics](/docs/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics).
...
using [streaming and replication](/docs/streaming/understanding-how-streaming-works).
...
dashboard, [configure the Agent](/docs/configuring/configuration) to collect
metrics less often.
...
See how
to [change how long Netdata stores metrics](/docs/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics).
...
on [streaming and replication](/docs/streaming/understanding-how-streaming-works).
...
see [reverse proxies](/docs/configuring/securing-netdata-agents/reverse-proxies).
