...
learn_link: "https://learn.netdata.cloud/docs/configuring/common-configuration-changes"
---
...
using [`edit-config`](/docs/configuring/configuration) from the Netdata config
directory.

## Change dashboards and visualizations

The Netdata Agent's [local dashboard](/docs/visualizations/accessing-netdata-dashboards), accessible
at `http://NODE:19999` is highly configurable. If
you use Netdata Cloud
for [infrastructure monitoring](/docs/architecture/the-role-of-netdata-cloud), you
...
Read our doc
on [increasing long-term metrics storage](/docs/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics)
...
alert, [view your active alerts](/docs/monitor-your-infrastructure/view-active-alerts) in
...
notifications](/docs/alerting/notifications#netdata-agent) doc
...
Learn more about the available options in the [security design documentation](/docs/architecture/security-and-privacy-design).

## Reduce resource usage

Read
our [performance optimization guide](/docs/configuring/how-to-optimize-the-netdata-agent-s-performance)
...
the [host label guide](/docs/configuring/organize-systems-metrics-and-alerts).
