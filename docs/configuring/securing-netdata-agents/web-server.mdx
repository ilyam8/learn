...
| `custom dashboard_info.js`                 | ` `                                                                                                                                                                                    | Specifies the location of a custom `dashboard.js` file. See [customizing the standard dashboard](/docs/miscellaneous/customize-the-standard-dashboard#customize-the-standard-dashboard) for details.                                                                                                                                                                                                                         |
