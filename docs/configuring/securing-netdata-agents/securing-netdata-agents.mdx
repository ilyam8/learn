---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/category-overview-pages/secure-nodes.md"
sidebar_label: "Securing Netdata Agents"
...
learn_link: "https://learn.netdata.cloud/docs/configuring/securing-netdata-agents/securing-netdata-agents"
---
...
Save and close the editor, then [restart your Agent](/docs/maintaining/starting-and-stopping-netdata-agents) 
...
> See the [configuration basics doc](/docs/configuring/configuration) for details on how to find 
...
[lighthttpd](/docs/configuring/securing-netdata-agents/reverse-proxies/lighttpd-v1.4.x), 
[caddy](/docs/configuring/securing-netdata-agents/reverse-proxies/caddy), and
[H2O](/docs/configuring/securing-netdata-agents/reverse-proxies/h2o).
...
For more information see [Streaming and replication](/docs/streaming/understanding-how-streaming-works).
