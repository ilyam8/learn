...
<img src="https://img.shields.io/badge/Version-3.7.94-informational" alt="Version: 3.7.94"></img>

<img loading="lazy" src="https://img.shields.io/badge/AppVersion-v1.46.1-informational" alt="AppVersion: v1.46.1" class="img_node_modules-@docusaurus-theme-classic-lib-theme-MDXComponents-Img-styles-module"></img>
...
- [HDFS](/docs/collecting-metrics/storage,-mount-points-and-filesystems/hadoop-distributed-file-system-hdfs)
...
the [Prometheus](/docs/collecting-metrics/generic-collecting-metrics/prometheus-endpoint) collector.
