...
sidebar_label: "Database modes for parent child setups"
...
sidebar_position: "210161"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/optimizing-metrics-database/database-modes-for-parent-child-setups"
---
