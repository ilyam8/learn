...
sidebar_position: "634000"
slug: "/data-collection/containers-and-vms/cgroups"
---
...
following [pattern list](/docs/contributing/libnetdata/simple-patterns):
...
the [proc plugin](/docs/data-collection/linux-systems/os-provided-metrics#monitored-network-interface-metrics).
