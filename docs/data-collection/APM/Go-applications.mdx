...
-   [External plugins - charts](/docs/contributing/external-plugins#chart)
-   [Chart variables](/docs/contributing/external-plugins/python.d.plugin#global-variables-order-and-chart)
...
[External plugins - dimensions](/docs/contributing/external-plugins#dimension)
