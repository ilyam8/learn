...
sidebar_label: "OS provided metrics"
learn_status: "Published"
toc_max_heading_level: "4"
learn_rel_path: "Data collection/Linux Systems"
sidebar_position: "618000"
slug: "/data-collection/linux-systems/os-provided-metrics"
---
...
> [!NOTE]  
> Temperature, fan speed, voltage and power metrics for AMD GPUs can be monitored using the [Sensors](/docs/data-collection/hardware-devices-and-sensors/sensors) plugin.
