...
[**Overview**](/docs/monitor-your-infrastructure/home-overview-and-single-node-view), which uses composite charts to display
...
doc](/docs/installing/kubernetes) for details on visualizing Kubernetes metrics in Netdata Cloud.
...
filtering](/docs/monitor-your-infrastructure/node-filter) and the [time &amp; date
picker](/docs/monitor-your-infrastructure/visualization-date-and-time-controls), to widen or narrow your infrastructure
monitoring focus.
...
Use [_group by node_](/docs/monitor-your-infrastructure/home-overview-and-single-node-view#group-by-dimension-or-node) to visualize
...
All of the familiar [interactions](/docs/visualizations/netdata-charts) are available, as is adding any chart
to a [new dashboard](/docs/visualizations/custom-dashboards).

## Nodes tab

You can also use the **Nodes tab** to monitor the health status and user-configurable key metrics from multiple nodes
in a War Room. Read the [Nodes tab documentation](/docs/visualizations/nodes-view) for details.
