...
To do both, you'll need to create or modify alert configuration files. The process is covered in the [Health Reference](/docs/alerts-&-notifications/health-configuration-reference) documentation.
