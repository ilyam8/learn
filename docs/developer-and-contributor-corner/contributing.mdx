...
See the [documentation contribution guidelines](/docs/developer-and-contributor-corner/contribute-to-the-documentation) for information on how you can help. 
...
4. Develop ⛏
   ...
   3. **For Python collectors:**
      1. Follow the contribution guidelines on the [python.d](/docs/developer-and-contributor-corner/external-plugins/python.d.plugin) documentation.
   ...
   4. **For Golang collectors:**
      1. Follow the contribution guidelines on the [go.d](/docs/developer-and-contributor-corner/external-plugins/go.d.plugin) documentation.
      2. Follow the Guide we have released: [How to develop a go.d collector](/docs/developer-and-contributor-corner/external-plugins/go.d.plugin/how-to-write-a-netdata-collector-in-go).
   5. **For Shell/Bash**
     1. Follow the guidelines on the [charts.d](/docs/developer-and-contributor-corner/external-plugins/charts.d.plugin).
   6. **For StatsD:**
...
To do both, you will need to create (or modify) alarm configuration files. Our [documentation](/docs/alerts-&-notifications/health-configuration-reference) details the process. To develop and test the alarm, you will only need an active installation of the Netdata Agent, so the developer container described above is not required.
...
- Use the [custom endpoint](/docs/alerts-&-notifications/notifications/agent-dispatched-notifications/custom) notification as boilerplate.


## Code of Conduct and CLA

We expect all contributors to abide by the [Contributor Covenant Code of Conduct](/docs/developer-and-contributor-corner/community-code-of-conduct). For a pull request to be accepted, you will also need to accept the [Netdata contributors license agreement](https://cla-assistant.io/netdata/netdata), as part of the PR process.
